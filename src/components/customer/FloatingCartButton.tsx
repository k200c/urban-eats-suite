...
export function FloatingCartButton() {
  ...
  return (
    <button
      ...
      className="fixed left-4 right-4 z-50 mx-auto max-w-md transition-transform duration-300 ease-out"
      style={{ bottom: 'calc(var(--bottom-nav-height) + var(--safe-bottom) + 0.5rem)' }}
    >
